...
var Enums_1 = __webpack_require__(/*! ./Enums */ 1388);
...
function (_Phaser$GameObjects$G) {
  ...
  _createClass(Ball, [{
    ...
    value: function setupSprite() {
      ...
      var spr = this._scene.add.image(0, 0, 'Ball_' + String(this._type) + '_' + String(c)).setScale(.220 * this._scene.GameSpriteScale).setOrigin(.5);
...
var RoomManager_1 = __webpack_require__(/*! ../objects/Managers/RoomManager */ 1391);

var ObjMapManager_1 = __webpack_require__(/*! ../objects/Managers/ObjMapManager */ 1393);

var ScoreManager_1 = __webpack_require__(/*! ../objects/Managers/ScoreManager */ 1398);

var MenuUI_1 = __webpack_require__(/*! ../objects/MenuUI */ 1400);
...
var Enums_1 = __webpack_require__(/*! ../../objects/Enums */ 1388);

var EditorManager_1 = __webpack_require__(/*! ../../objects/Managers/EditorManager */ 1385);

var ShopManager_1 = __webpack_require__(/*! ../../objects/Managers/ShopManager */ 1392);
...
function (_Phaser$GameObjects$G) {
  ...
  _createClass(ShopManager, [{
    ...
    value: function setupCoins() {
      ...
      var spr;
      var txt;
      spr = this.setupSprite(446, 33, 'Coin', 24, false, .18);
      spr.depth = 24;
      ...
      for (var i = 0; i < maxI; i++) {
        var _loop = function _loop(j) {
          ...
          for (var k = 0; k < 3; k++) {
            ...
            balls[k] = _this2.setupSprite(ballPos[k].x + xOff, ballPos[k].y + yOff, s, 21, false, .2);
          }
...
var Path_1 = __webpack_require__(/*! ../../objects/Path */ 1394);

var Ball_1 = __webpack_require__(/*! ../../objects/Ball */ 1389);

var Coin_1 = __webpack_require__(/*! ../../objects/Coin */ 1395);

var Player_1 = __webpack_require__(/*! ../../objects/Player */ 1396);
...
function (_Phaser$GameObjects$G) {
  ...
  _createClass(Coin, [{
    ...
    value: function create() {
      ...
      this.defineManagers();
      this.animationManagment(.2, 1, 750, false);
    }
  }, {
    key: "update",
    value: function update() {
...
var Player_Ball_1 = __webpack_require__(/*! ../objects/Player_Ball */ 1397);
...
function (_Phaser$GameObjects$G) {
  ...
  _createClass(Player, [{
    ...
    value: function setupSprite(key, depth) {
      var spr = this._scene.physics.add.image(this._x, this._y, key).setScale(.3 * this._scene.GameSpriteScale).setOrigin(.5, .55);
  ...
  _createClass(Player_Ball, [{
    ...
    value: function update() {
      if (!this._scene.inWorldBounds(this._sprite) || this._RM.IsGameOver) {
        ...
        this.animationManagment(.220 * this._scene.GameSpriteScale);
...
var playsiveSDK_js_1 = __webpack_require__(/*! ../../playsive/playsiveSDK.js */ 1399);
...
function (_Phaser$GameObjects$G) {
  ...
  _createClass(MenuUI, [{
    ...
    value: function setupRewardUI() {
      ...
      var prizeSpr = this.setupSprite(414, 641, 'GiftBoxIcon', 17, false, .44);
...
module.exports = __webpack_require__(/*! D:\phaser\Ball Line\ball-line-source-code.1.0.0.5\src\main.ts */502);
...
__webpack_require__(/*! phaser */ 237);

var PlayScene_1 = __importDefault(__webpack_require__(/*! ./scenes/PlayScene */ 1390));

var Preloader_1 = __importDefault(__webpack_require__(/*! ./scenes/Preloader */ 1387)); // main painle changes
